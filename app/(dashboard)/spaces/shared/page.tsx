  ...
  return (
    <main className="flex flex-col items-center p-8">
      <div className="w-full max-w-2xl">
          ...
          <div className="space-y-2">
            {spaces.map((space) => (
              <button
                ...
                className="w-full flex items-center gap-3 bg-white rounded-2xl ring-1 ring-black/5 shadow-sm p-4 hover:ring-amber-300 transition-all text-left"
              >
        ...
        {/* TODO: invite-link sharing (share sheet, copy link), member
            list, and leave-space (for non-owners) all go here - separate
            follow-up, not built yet. sharedSpaces.ts already has
            createInviteLink/previewInvite/redeemInvite/fetchSpaceMembers/
            removeMember/leaveSpace ready for it. */}
      </div>
    </main>
  );
}
